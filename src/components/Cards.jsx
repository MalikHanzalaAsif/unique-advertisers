          ...
          return (
            <div className="card relative" key={index}>
              <div className="bg-gray-100 flex items-center justify-center rounded-md h-full relative">
                <div className="max-w-md bg-slate-200 p-6 rounded-md shadow-md h-full hover:shadow-lg transition-all">
                  {categories.length > 0 && (
                  ...
                  <h2 className="text-2xl mb-2 text-black">{title.rendered}</h2>
